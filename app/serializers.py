...
class RecipientsMixin:
    ...
    @classmethod
    def create_recipients(cls, recipients_data):
        recipients = []
...
class RecipientSerializer(serializers.HyperlinkedModelSerializer, PersonMixin):
    ...
    def create(self, validated_data):
        ...
        recipient = Recipient.objects.create(person=person, **validated_data)
...
class ScheduledMailSerializer(serializers.HyperlinkedModelSerializer, EmailMixin, RecipientsMixin):
    ...
    def create(self, validated_data):
        ...
        scheduled_mail.recipients.add(*self.create_recipients(recipients_data))
